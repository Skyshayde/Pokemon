...
public class People {
	...
	public void setPeople() {
		people[0] = new PersonQuest("Rachel", Player.getLastName(), "Mom", PeopleType.FAMILY, false, 1);
			...
			people[0].heals(true);
		people[1] = new PersonQuest("Bruce", Player.getLastName(), "Dad", PeopleType.FAMILY, true, 2);
